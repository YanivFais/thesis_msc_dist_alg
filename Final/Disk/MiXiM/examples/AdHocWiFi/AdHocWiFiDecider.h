...
protected:
	...
	/**
	 * Ratio for sensitivity for receiving  RTS packats
	 */
	double RtsSensitivityRatio;

	/**
	 * pointer to parent phy
	 */
	AdHocWiFiPhyLayer * AHphy;
...
public:
	...
	AdHocWiFiDecider(DeciderToPhyInterface* phy,
	  ...
	  RtsSensitivityRatio(RtsSensitivityRatioP), AHphy(ahphy)
	{}
