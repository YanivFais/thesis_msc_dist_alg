...
private:
	 ...
	 * @param newRate new rate for stream
	 * @param oldRate old rate for stream
	 * @param streamNumber number of stream working on
	 * @param msgBits message size in bits
	 */
	void updateWeight(unsigned long &newRate,unsigned long oldRate,int streamNumber,unsigned long msgBits);
